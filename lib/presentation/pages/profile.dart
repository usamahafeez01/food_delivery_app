...
///------ Image Uploader---------
  uploadItem() async {
    if (selectedImage != null) {
      ...
      await SharedPrefferenceHelper().SaveUserProfile(downloadUrl);
      setState(() {
  ...
  getthesharedpref() async {
    profile = await SharedPrefferenceHelper().getUserProfile();
    name = await SharedPrefferenceHelper().getUserName();
    email = await SharedPrefferenceHelper().getUserEmail();
    setState(() {});
  }
